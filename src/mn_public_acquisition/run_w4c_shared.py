...
from .extract_w4c_shared_v2 import run
...
def main() -> None:
    ...
    try:
        ...
        result = {
            ...
            "private_repository": cfg.get("private_repository"),
            "private_release_tag": cfg.get("release_tag"),
            "results": [],
            "failures": [{"source_set_id": "W4C_SHARED", "error": str(exc)}],
            "complete": False,
        }
